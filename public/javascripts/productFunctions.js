					...
					for (var i = 0; i < data.length; i++) 
					{
						...
						if($('#hasSizesEdit').prop('checked')==false&&$('#hasColorsEdit').prop('checked')==true)
						{
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal1' id='editColorTotal1' onchange='updateEditTotals()' value='"+data[i].color1Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal2' id='editColorTotal2' onchange='updateEditTotals()' value='"+data[i].color2Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal3' id='editColorTotal3' onchange='updateEditTotals()' value='"+data[i].color3Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal4' id='editColorTotal4' onchange='updateEditTotals()' value='"+data[i].color4Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal5' id='editColorTotal5' onchange='updateEditTotals()' value='"+data[i].color5Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal6' id='editColorTotal6' onchange='updateEditTotals()' value='"+data[i].color6Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal7' id='editColorTotal7' onchange='updateEditTotals()' value='"+data[i].color7Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal8' id='editColorTotal8' onchange='updateEditTotals()' value='"+data[i].color8Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal9' id='editColorTotal9' onchange='updateEditTotals()' value='"+data[i].color9Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal10' id='editColorTotal10' onchange='updateEditTotals()' value='"+data[i].color10Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
							}
						...
						if($('#hasSizesEdit').prop('checked')==true&&$('#hasColorsEdit').prop('checked')==true)
						{
							...
							{	
								...
								formControl += "<br>"
								formControl += "<div class='col-sm-2'>"
								formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal1' id='editColorTotal1' onchange='updateEditTotals()' ='"+data[i].color1Total+"'>"
								formControl += "</div>"
								formControl += "</div>"
								formControl += "</div><br>"
								...
								formControl +=			"<input type='number' name='editSizeS1' id='editSizeS1' value='"+data[i].color1SizeS+"' onchange='updateEditTotals()'><label for='editSizeS1'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM1' id='editSizeM1' value='"+data[i].color1SizeM+"' onchange='updateEditTotals()'><label for='editSizeM1'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL1' id='editSizeL1' value='"+data[i].color1SizeL+"' onchange='updateEditTotals()'><label for='editSizeL1'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL1' id='editSizeXL1' value='"+data[i].color1SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL1'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL1' id='editSize2XL1' value='"+data[i].color1Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL1'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL1' id='editSize3XL1' value='"+data[i].color1Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL1'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL1' id='editSize4XL1' value='"+data[i].color1Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL1'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<input type='number' name='editSizeS2' id='editSizeS2' value='"+data[i].color2SizeS+"' onchange='updateEditTotals()'><label for='editSizeS2'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM2' id='editSizeM2' value='"+data[i].color2SizeM+"' onchange='updateEditTotals()'><label for='editSizeM2'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL2' id='editSizeL2' value='"+data[i].color2SizeL+"' onchange='updateEditTotals()'><label for='editSizeL2'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL2' id='editSizeXL2' value='"+data[i].color2SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL2'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL2' id='editSize2XL2' value='"+data[i].color2Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL2'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL2' id='editSize3XL2' value='"+data[i].color2Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL2'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL2' id='editSize4XL2' value='"+data[i].color2Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL2'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS3' id='editSizeS3' value='"+data[i].color3SizeS+"' onchange='updateEditTotals()'><label for='editSizeS3'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM3' id='editSizeM3' value='"+data[i].color3SizeM+"' onchange='updateEditTotals()'><label for='editSizeM3'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL3' id='editSizeL3' value='"+data[i].color3SizeL+"' onchange='updateEditTotals()'><label for='editSizeL3'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL3' id='editSizeXL3' value='"+data[i].color3SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL3'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL3' id='editSize2XL3' value='"+data[i].color3Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL3'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL3' id='editSize3XL3' value='"+data[i].color3Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL3'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL3' id='editSize4XL3' value='"+data[i].color3Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL3'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS4' id='editSizeS4' value='"+data[i].color4SizeS+"' onchange='updateEditTotals()'><label for='editSizeS4'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM4' id='editSizeM4' value='"+data[i].color4SizeM+"' onchange='updateEditTotals()'><label for='editSizeM4'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL4' id='editSizeL4' value='"+data[i].color4SizeL+"' onchange='updateEditTotals()'><label for='editSizeL4'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL4' id='editSizeXL4' value='"+data[i].color4SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL4'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL4' id='editSize2XL4' value='"+data[i].color4Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL4'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL4' id='editSize3XL4' value='"+data[i].color4Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL4'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL4' id='editSize4XL4' value='"+data[i].color4Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL4'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS5' id='editSizeS5' value='"+data[i].color5SizeS+"' onchange='updateEditTotals()'><label for='editSizeS5'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM5' id='editSizeM5' value='"+data[i].color5SizeM+"' onchange='updateEditTotals()'><label for='editSizeM5'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL5' id='editSizeL5' value='"+data[i].color5SizeL+"' onchange='updateEditTotals()'><label for='editSizeL5'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL5' id='editSizeXL5' value='"+data[i].color5SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL5'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL5' id='editSize2XL5' value='"+data[i].color5Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL5'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL5' id='editSize3XL5' value='"+data[i].color5Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL5'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL5' id='editSize4XL5' value='"+data[i].color5Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL5'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS6' id='editSizeS6' value='"+data[i].color6SizeS+"' onchange='updateEditTotals()'><label for='editSizeS6'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM6' id='editSizeM6' value='"+data[i].color6SizeM+"' onchange='updateEditTotals()'><label for='editSizeM6'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL6' id='editSizeL6' value='"+data[i].color6SizeL+"' onchange='updateEditTotals()'><label for='editSizeL6'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL6' id='editSizeXL6' value='"+data[i].color6SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL6'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL6' id='editSize2XL6' value='"+data[i].color6Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL6'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL6' id='editSize3XL6' value='"+data[i].color6Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL6'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL6' id='editSize4XL6' value='"+data[i].color6Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL6'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS7' id='editSizeS7' value='"+data[i].color7SizeS+"' onchange='updateEditTotals()'><label for='editSizeS7'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM7' id='editSizeM7' value='"+data[i].color7SizeM+"' onchange='updateEditTotals()'><label for='editSizeM7'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL7' id='editSizeL7' value='"+data[i].color7SizeL+"' onchange='updateEditTotals()'><label for='editSizeL7'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL7' id='editSizeXL7' value='"+data[i].color7SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL7'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL7' id='editSize2XL7' value='"+data[i].color7Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL7'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL7' id='editSize3XL7' value='"+data[i].color7Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL7'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL7' id='editSize4XL7' value='"+data[i].color7Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL7'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS8' id='editSizeS8' value='"+data[i].color8SizeS+"' onchange='updateEditTotals()'><label for='editSizeS8'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM8' id='editSizeM8' value='"+data[i].color8SizeM+"' onchange='updateEditTotals()'><label for='editSizeM8'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL8' id='editSizeL8' value='"+data[i].color8SizeL+"' onchange='updateEditTotals()'><label for='editSizeL8'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL8' id='editSizeXL8' value='"+data[i].color8SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL8'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL8' id='editSize2XL8' value='"+data[i].color8Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL8'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL8' id='editSize3XL8' value='"+data[i].color8Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL8'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL8' id='editSize4XL8' value='"+data[i].color8Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL8'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS9' id='editSizeS9' value='"+data[i].color9SizeS+"' onchange='updateEditTotals()'><label for='editSizeS9'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM9' id='editSizeM9' value='"+data[i].color9SizeM+"' onchange='updateEditTotals()'><label for='editSizeM9'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL9' id='editSizeL9' value='"+data[i].color9SizeL+"' onchange='updateEditTotals()'><label for='editSizeL9'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL9' id='editSizeXL9' value='"+data[i].color9SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL9'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL9' id='editSize2XL9' value='"+data[i].color9Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL9'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL9' id='editSize3XL9' value='"+data[i].color9Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL9'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL9' id='editSize4XL9' value='"+data[i].color9Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL9'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
							...
							{	
								...
								formControl +=			"<label for='storeSizes' class='control-label'> Sizes</label><br>"
								formControl +=			"<input type='number' name='editSizeS10' id='editSizeS10' value='"+data[i].color10SizeS+"' onchange='updateEditTotals()'><label for='editSizeS10'>:S</label><br>"
								formControl +=			"<input type='number' name='editSizeM10' id='editSizeM10' value='"+data[i].color10SizeM+"' onchange='updateEditTotals()'><label for='editSizeM10'>:M</label><br>"
								formControl +=			"<input type='number' name='editSizeL10' id='editSizeL10' value='"+data[i].color10SizeL+"' onchange='updateEditTotals()'><label for='editSizeL10'>:L</label><br>"
								formControl +=			"<input type='number' name='editSizeXL10' id='editSizeXL10' value='"+data[i].color10SizeXL+"' onchange='updateEditTotals()'><label for='editSizeXL10'>:XL</label><br>"
								formControl +=			"<input type='number' name='editSize2XL10' id='editSize2XL10' value='"+data[i].color10Size2XL+"' onchange='updateEditTotals()'><label for='editSize2XL10'>:2XL</label><br>"
								formControl +=			"<input type='number' name='editSize3XL10' id='editSize3XL10' value='"+data[i].color10Size3XL+"' onchange='updateEditTotals()'><label for='editSize3XL10'>:3XL</label><br>"
								formControl +=			"<input type='number' name='editSize4XL10' id='editSize4XL10' value='"+data[i].color10Size4XL+"' onchange='updateEditTotals()'><label for='editSize4XL10'>:4XL</label><br>"
								formControl +=		"</div>"
								formControl +=	"</div>"	
								formControl +=	"<br>"
...
function addEditForm()
{
	...
	console.log(styleIndex);
			...
			{	
				...
				formControl += "<br>"
				formControl += "<div class='col-sm-2'>"
				formControl += "<p>Sub-Style Total:</p><input type='number' class='form-control input-lg required' required='required' name='editColorTotal"+i+"' id='editColorTotal"+i+"' onchange='updateEditTotals()' placeholder='0'>"
				formControl += "</div>"
				formControl += "</div>"
				formControl += "</div><br>"
				...
				formControl +=			"<label for='storeSizes' class='control-label'>Sizes</label><br>"
				formControl +=			"<input type='number' name='editSizeS"+i+"' id='editSizeS"+i+"' value='0' onchange='updateEditTotals()'><label for='editSizeS"+i+"'>:S</label><br>"
				formControl +=			"<input type='number' name='editSizeM"+i+"' id='editSizeM"+i+"' value='0' onchange='updateEditTotals()'><label for='editSizeM"+i+"'>:M</label><br>"
				formControl +=			"<input type='number' name='editSizeL"+i+"' id='editSizeL"+i+"' value='0' onchange='updateEditTotals()'><label for='editSizeL"+i+"'>:L</label><br>"
				formControl +=			"<input type='number' name='editSizeXL"+i+"' id='editSizeXL"+i+"' value='0' onchange='updateEditTotals()'><label for='editSizeXL"+i+"'>:XL</label><br>"
				formControl +=			"<input type='number' name='editSize2XL"+i+"' id='editSize2XL"+i+"' value='0' onchange='updateEditTotals()'><label for='editSize2XL"+i+"'>:2XL</label><br>"
				formControl +=			"<input type='number' name='editSize3XL"+i+"' id='editSize3XL"+i+"' value='0' onchange='updateEditTotals()'><label for='editSize3XL"+i+"'>:3XL</label><br>"
				formControl +=			"<input type='number' name='editSize4XL"+i+"' id='editSize4XL"+i+"' value='0' onchange='updateEditTotals()'><label for='editSize4XL"+i+"'>:4XL</label><br>"
				formControl +=		"</div>"
				formControl +=	"</div>"	
				formControl +=	"<br>"
