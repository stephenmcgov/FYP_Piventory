...
function controlForm(){
	...
	if($('#hasSizes').prop('checked')==true)
	{
		for(var i=1; i<styleIndex+1; i++)
		{
				...
				var showSubCork = document.getElementById("showSubCork").id + currStyle;
				var showSubKala = document.getElementById("showSubKala").id + currStyle;
				var showSubGalway = document.getElementById("showSubGalway").id + currStyle;
				var showSubWarehouse = document.getElementById("showSubWarehouse").id + currStyle;
...
function updateTotals(){
	if($('#hasSizes').prop('checked')==true&&$('#hasColors').prop('checked')==true)
	{
		...
		for(var i=1;i<styleIndex+1;i++)
		{
			...
			var countWarehouseSizeS = parseInt(document.getElementById(warehouseSizeS).value);
			var countWarehouseSizeM = parseInt(document.getElementById(warehouseSizeM).value);
			var countWarehouseSizeL = parseInt(document.getElementById(warehouseSizeL).value);
			var countWarehouseSizeXL = parseInt(document.getElementById(warehouseSizeXL).value);
			var countWarehouseSize2XL = parseInt(document.getElementById(warehouseSize2XL).value);
			var countWarehouseSize3XL = parseInt(document.getElementById(warehouseSize3XL).value);
			var countWarehouseSize4XL = parseInt(document.getElementById(warehouseSize4XL).value);
			var warehouseSizeTotal = parseInt(countWarehouseSizeS) + parseInt(countWarehouseSizeM) + parseInt(countWarehouseSizeL) + parseInt(countWarehouseSizeXL) + parseInt(countWarehouseSize2XL) + parseInt(countWarehouseSize3XL) + parseInt(countWarehouseSize4XL);
			...
			var countCorkSizeS = parseInt(document.getElementById(corkSizeS).value);
			var countCorkSizeM = parseInt(document.getElementById(corkSizeM).value);
			var countCorkSizeL = parseInt(document.getElementById(corkSizeL).value);
			var countCorkSizeXL = parseInt(document.getElementById(corkSizeXL).value);
			var countCorkSize2XL = parseInt(document.getElementById(corkSize2XL).value);
			var countCorkSize3XL = parseInt(document.getElementById(corkSize3XL).value);
			var countCorkSize4XL = parseInt(document.getElementById(corkSize4XL).value);
			var corkSizeTotal = parseInt(countCorkSizeS) + parseInt(countCorkSizeM) + parseInt(countCorkSizeL) + parseInt(countCorkSizeXL) + parseInt(countCorkSize2XL) + parseInt(countCorkSize3XL) + parseInt(countCorkSize4XL);
			...
			var countkalaSizeS = parseInt(document.getElementById(kalaSizeS).value);
			var countkalaSizeM = parseInt(document.getElementById(kalaSizeM).value);
			var countkalaSizeL = parseInt(document.getElementById(kalaSizeL).value);
			var countkalaSizeXL = parseInt(document.getElementById(kalaSizeXL).value);
			var countkalaSize2XL = parseInt(document.getElementById(kalaSize2XL).value);
			var countkalaSize3XL = parseInt(document.getElementById(kalaSize3XL).value);
			var countkalaSize4XL = parseInt(document.getElementById(kalaSize4XL).value);
			var kalaSizeTotal = countkalaSizeS + countkalaSizeM + countkalaSizeL + countkalaSizeXL + countkalaSize2XL + countkalaSize3XL + countkalaSize4XL;
			...
			var countgalwaySizeS = parseInt(document.getElementById(galwaySizeS).value);
			var countgalwaySizeM = parseInt(document.getElementById(galwaySizeM).value);
			var countgalwaySizeL = parseInt(document.getElementById(galwaySizeL).value);
			var countgalwaySizeXL = parseInt(document.getElementById(galwaySizeXL).value);
			var countgalwaySize2XL = parseInt(document.getElementById(galwaySize2XL).value);
			var countgalwaySize3XL = parseInt(document.getElementById(galwaySize3XL).value);
			var countgalwaySize4XL = parseInt(document.getElementById(galwaySize4XL).value);
			var galwaySizeTotal = parseInt(document.getElementById(galwaySizeS).value) + parseInt(document.getElementById(galwaySizeM).value) + parseInt(countgalwaySizeL) + parseInt(countgalwaySizeXL) + parseInt(countgalwaySize2XL) + parseInt(countgalwaySize3XL) + parseInt(countgalwaySize4XL);
	...
	{		
			...
			var countKalaSize3XL = parseInt(document.getElementById("kalaSize3XL").value);
			var countKalaSize4XL = parseInt(document.getElementById("kalaSize4XL").value);
			var kalaSizeTotal = parseInt(countKalaSizeS) + parseInt(countKalaSizeM) + parseInt(countKalaSizeL) + parseInt(countKalaSizeXL) + parseInt(countKalaSize2XL) + parseInt(countKalaSize3XL) + parseInt(countKalaSize4XL);
			...
			var countGalwaySize3XL = parseInt(document.getElementById("galwaySize3XL").value);
			var countGalwaySize4XL = parseInt(document.getElementById("galwaySize4XL").value);
			var galwaySizeTotal = parseInt(countGalwaySizeS) + parseInt(countGalwaySizeM) + parseInt(countGalwaySizeL) + parseInt(countGalwaySizeXL) + parseInt(countGalwaySize2XL) + parseInt(countGalwaySize3XL) + parseInt(countGalwaySize4XL);
