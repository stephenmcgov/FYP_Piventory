...
function addForm()
{
	...
	{	
		...
		formControl +=			"<input type='number' min='0' name='sizeS"+i+"' id='sizeS"+i+"' value='0' onchange='updateTotals()'><label for='sizeS"+i+"'>:S</label><br>"
		formControl +=			"<input type='number' min='0' name='sizeM"+i+"' id='sizeM"+i+"' value='0' onchange='updateTotals()'><label for='sizeM"+i+"'>:M</label><br>"
		formControl +=			"<input type='number' min='0' name='sizeL"+i+"' id='sizeL"+i+"' value='0' onchange='updateTotals()'><label for='sizeL"+i+"'>:L</label><br>"
		formControl +=			"<input type='number' min='0' name='sizeXL"+i+"' id='sizeXL"+i+"' value='0' onchange='updateTotals()'><label for='sizeXL"+i+"'>:XL</label><br>"
		formControl +=			"<input type='number' min='0' name='size2XL"+i+"' id='size2XL"+i+"' value='0' onchange='updateTotals()'><label for='size2XL"+i+"'>:2XL</label><br>"
		formControl +=			"<input type='number' min='0' name='size3XL"+i+"' id='size3XL"+i+"' value='0' onchange='updateTotals()'><label for='size3XL"+i+"'>:3XL</label><br>"
		formControl +=			"<input type='number' min='0' name='size4XL"+i+"' id='size4XL"+i+"' value='0' onchange='updateTotals()'><label for='size4XL"+i+"'>:4XL</label><br>"
		formControl +=		"</div>"
		formControl +=	"</div>"	
		formControl +=	"<br>"
